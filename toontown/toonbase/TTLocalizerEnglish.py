...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'CigarSmoke': ["Where's a Surgeon General when you need one?",
                ...
                "Some would say I'm just blowing smoke.",
                "Hard to breathe?"],
...
CdrResultTooManyFails = "We're sorry. You've tried to enter an incorrect code too many times. Please try again after %d minutes."
