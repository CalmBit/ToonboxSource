...
NametagColors = {
    CCNormal: (
        (VBase4(0.8, 0.2, 0.2, 1.0), VBase4(0.8, 0.8, 0.8, 0.375)),   # Normal
        (VBase4(0.6, 0.2, 0.0, 1.0), VBase4(0.2, 0.2, 0.2, 0.1875)),  # Down
        (VBase4(0.8, 0.2, 0.2, 1.0), VBase4(1.0, 1.0, 1.0, 0.5625)),  # Rollover
        (VBase4(0.8, 0.2, 0.2, 1.0), VBase4(1.0, 1.0, 1.0, 0.375))    # Disabled
    ),
    CCNoChat: (
    ...
    CCSuit: (
        ...
        (VBase4(0.2, 0.2, 0.2, 1.0), VBase4(1.0, 1.0, 1.0, 0.5625)),  # Rollover
