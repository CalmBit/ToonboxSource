...
class DistributedLawbotCannonAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def requestEnter(self):
        ...
        if self.avId == 0 or self.avId == avId:
            ...
            self.air.writeServerEventMessage('suspicious', avId, 'DistributedCannonAI.requestEnter cannon already occupied')
    ...
    def requestLeave(self):
        ...
        if self.avId != 0:
            ...
            self.air.writeServerEventMessage('suspicious', avId, 'DistributedCannonAI.requestLeave cannon not occupied')
